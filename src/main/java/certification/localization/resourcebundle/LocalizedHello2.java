...
public class LocalizedHello2 {
    ...
    public static void main(String[] args) {
        ...
        printMovieDetails(ResourceBundle.getBundle("certification.localization.resourcebundle.ResBundle", locale1));

        Locale locale2 = new Locale("it", "IT");
        printMovieDetails(ResourceBundle.getBundle("certification.localization.resourcebundle.ResBundle", locale2));
    }
}
